module llvm.Support.Error;

/// Base class for error info classes. Do not extend this directly: Extend
/// the ErrorInfo template subclass instead.
class ErrorInfoBase
{
    abstract void log(raw_stream OS);

    //virtual ~ErrorInfoBase() = default;
    pragma(inline) final void log(raw_ostream &OS) const
    {
        return vtable.log(&this, )
    }
    ...
    abstract std::error_code convertToErrorCode() const;
